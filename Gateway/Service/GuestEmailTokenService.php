...
class GuestEmailTokenService implements ApiServiceInterface
{
    ...
    public function execute(array $subject): DataObject
    {
        ...
        if (!isset($subject['paymentIntentId'])) {
            throw new InvalidArgumentException('paymentIntentId should be provided');
        }
