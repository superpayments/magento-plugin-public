    ...
    private function getRequestData(): ?array
    {
        ...
        try {
            ...
            $data['isDuplicateWebhook'] = (
                isset($additionalInfo['transactionId']) &&
                $additionalInfo['transactionId'] == $data['transactionId'] &&
